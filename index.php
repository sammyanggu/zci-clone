      ...
      <div class="slider swiper-container">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide slide-2"> 
            <!--<div class="slide-bg-img" data-bg-img="assets/images/hero/hero-bg-2-edited.jpg">
              <div class="overlay-color" data-bg-opacity=".35"></div>
            </div>-->
            <div class="container">
              <div class="hero-text-area content-always-light">
                <div class="row">
                  ...
                  <div class="col-10 col-md-8 col-lg-6">
                    <p class="slide-subtitle">
                      Many years of structured cabling experience from towers, offices and large data centers.
                    </p>
                  </div>
                  <div class="col-12">
                    <div class="cta-links-area"><a class="btn-solid cta-link cta-link-primary" href="contact-us.php">contact us</a>
            ...
            <div class="container">
              <div class="hero-text-area content-always-light">
                <div class="row">
                  ...
                  <div class="col-12 col-md-8 col-lg-7">
                    <h1 class="slide-title">Building Management Systems — <span class="featured-text">Seamless Managed Service </span><span class="design-element rounded-shape stripes"></span></h1>
                  </div>
                  <div class="col-10 col-md-8 col-lg-6">
                    <p class="slide-subtitle">
                  ...
                  <div class="col-12">
                    <div class="cta-links-area"><!-- <a class="btn-solid cta-link cta-link-primary" href="#0">start now</a> --><a class="btn-outline cta-link" href="contact-us.php">Contact us</a></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <!--Navigation elements removed - auto-slide only-->
            </div>
          </div>
        </div>
      </div>
